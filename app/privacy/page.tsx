...
export default async function Page() {
  return (
    <div className="prose container my-4">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to AlterOpen.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to AlterOpen, accessible from{" "}
            <a href="https://alteropen.com/" target="_blank">
              https://alteropen.com/
            </a>
          </p>
        </li>
      ...
      <ul>
        <li>By email: contact(at)alteropen.com</li>
      </ul>
    </div>
  )
}
