    ...
    <div className="prose container my-4">
      <div>
        <div>
          ...
          <p>
            <strong>Last updated</strong> <strong>July 31, 2024</strong>
          </p>
          <div>
        ...
        <div>
          <div>
            We are AlterOpen ("<strong>Company</strong>," "<strong>we</strong>,"
            "<strong>us</strong>," "<strong>our</strong>"), a company registered
            in Vietnam at Du Hang, Hai Phong 18000.
          </div>
        </div>
        <div>
          <div>
            We operate the website alteropen.com (the "<strong>Site</strong>"),
            the mobile application AlterOpen (the "<strong>App</strong>"), as
          ...
          <div>
            You can contact us by email at contact@alteropen.com or by mail to
            Du Hang, Hai Phong 18000,&nbsp;Vietnam.
          </div>
          <div>
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity ("
            <strong>you</strong>"), and AlterOpen, concerning your access to and
        ...
        <div>
          ...
          <div>
            <a href="#returnyes">8. REFUNDS POLICY</a>
          </div>
          <div>
          ...
          <div>
            <a href="#advertisers">16. ADVERTISERS</a>
          </div>
          <div>
            <a href="#sitemanage">17. SERVICES MANAGEMENT</a>
          </div>
          <div>
            <a href="#ppyes">18. PRIVACY POLICY</a>
          </div>
          <div>
          ...
          <div>
            <a href="#sms">29. SMS TEXT MESSAGING</a>
          </div>
          <div>
            <a href="#california">30. CALIFORNIA USERS AND RESIDENTS</a>
          </div>
          <div>
            <a href="#misc">31. MISCELLANEOUS</a>
          </div>
          <div>
            <a href="#contact">32. CONTACT US</a>
          </div>
        </div>
        <div>
          <div></div>
        ...
        <div>
          ...
          <div>
            ...
            please address your request to: contact@alteropen.com. If we ever
        ...
        <div>
          ...
          <div>
            ...
            our Services, please email us at contact@alteropen.com.
          </div>
          <div>
        ...
        <div>
          ...
          <div>
            ...
            <strong>
              &nbsp;
              <a href="https://alteropen.com/privacy" target="_blank">
                https://alteropen.com/privacy
              </a>
            </strong>
            . By using the Services, you agree to be bound by our Privacy
            Policy, which is incorporated into these Legal Terms. Please be
            advised the Services are hosted in the United States, Finland,
            Germany, Vietnam, Singapore and United Kingdom. If you access the
            ...
            that differ from applicable laws in the United States, Finland,
            Germany, Vietnam, Singapore and United Kingdom, then through your
            continued use of the Services, you are transferring your data to the
            United States, Finland, Germany, Vietnam, Singapore and United
            Kingdom, and you expressly consent to have your data transferred to
            and processed in the United States, Finland, Germany, Vietnam,
          ...
          <div>
            ...
            laws of Vietnam. AlterOpen and yourself irrevocably consent that the
            courts of Vietnam shall have exclusive jurisdiction to resolve any
          ...
          <div>
            ...
            the jurisdiction of the Vietnam courts. AlterOpen shall also
          ...
          <div>
            ...
            (1) your Contributions;&nbsp;(2) use of the Services; (3) breach of
          ...
          <div>
            ...
            communications, please email us at contact@alteropen.com.
          </div>
          <div>
            <strong>
              <strong>
          ...
          <div>
            <strong>AlterOpen</strong>
          </div>
          <div>
            <strong>Du Hang</strong>
          </div>
          <div>
            <strong>Hai Phong 18000</strong>
          </div>
          <div>
          ...
          <div>
            <strong>
              <strong>contact(at)alteropen.com</strong>
            </strong>
          </div>
        </div>
      </div>
